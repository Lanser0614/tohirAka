            ...
            <div class="tab-content">
                                ...
                                <tbody>
                                            <tr>
                                             ...
                                             >
                                                ...
                                                <td>
                                                   <span > <a href="destroyCountry/{{$item->id}}" class="tag tag-green">DELETE</a></span>
                                                </td>
                                                <td>
                                                    <span > <a href="showCountry/{{$item->id}}" class="tag tag-blue">Edit</a></span>
                                                </td>
                                            </tr>
                                        </tbody>
                                        @endforeach
                ...
                <div class="tab-pane fade active show" id="todo-add" role="tabpanel">
                    <div class="card">
                        ...
                        <form class="card-body" method="POST" action="{{ route('storeCountry') }}" enctype="multipart/form-data">
                            @csrf
