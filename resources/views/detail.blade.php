...
<style>
  ...
  background-image: url({{asset('files/'. $tour->img)}});
}
</style>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-9">
                ...
                <div class="contact_join">
                    ...
                    <form action="{{ route('callback') }}" method="POST 63333333333">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="single_input">
                                    <textarea name="" id="" cols="30" name="place" rows="10"placeholder="Message" ></textarea>
                                </div>
                            </div>
                            <div class="col-lg-12">
