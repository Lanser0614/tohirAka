...
<!-- Plugins css -->
<link rel="stylesheet" href="{{asset('assetsAdmin/plugins/charts-c3/c3.min.css')}}"/>
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.15.3/css/all.css" integrity="sha384-SZXxX4whJ79/gErwcOYf+zWLeJdY/qpuqC4cAa9rOGUstPomtqpuNWT9wdPEn2fk" crossorigin="anonymous">

<!-- Core css -->
<link rel="stylesheet" href="{{asset('assetsAdmin/css/main.css')}}"/>
<link rel="stylesheet" href="{{asset('assetsAdmin/css/theme1.css')}}"/>
</head>
    ...
    <div id="header_top" class="header_top">
        <div class="container">
            <div class="hleft">
                ...
                <div class="dropdown">
                    <a href="javascript:void(0)" class="nav-link user_btn"><img class="avatar" src="{{asset('assetsAdmin/images/user.png')}}" alt="" data-toggle="tooltip" data-placement="right" title="User Menu"/></a>
       </div>
            </div>
    ...
    <div id="left-sidebar" class="sidebar ">
        ...
        <nav id="left-sidebar-nav" class="sidebar-nav">
            <ul class="metismenu">
                ...
                <li class="active"><a href="/Country"><i class="fas fa-tachometer-alt"></i><span>Country</span></a></li>      
                <li class="active"><a href="/Tour"><i class="fas fa-tachometer-alt"></i><span>Tour</span></a></li>    
                <li class="active"><a href="/Detail"><i class="fas fa-tachometer-alt"></i><span>Site Detail</span></a></li>                     
...
<script src="{{asset('assetsAdmin/bundles/lib.vendor.bundle.js')}}"></script>

<script src="{{asset('assetsAdmin/bundles/apexcharts.bundle.js')}}"></script>
<script src="{{asset('assetsAdmin/bundles/counterup.bundle.js')}}"></script>
<script src="{{asset('assetsAdmin/bundles/knobjs.bundle.js')}}"></script>
<script src="{{asset('assetsAdmin/bundles/c3.bundle.js')}}"></script>

<script src="{{asset('assetsAdmin/js/core.js')}}"></script>
<script src="{{asset('assetsAdmin/js/page/project-index.js')}}"></script>
</body>
